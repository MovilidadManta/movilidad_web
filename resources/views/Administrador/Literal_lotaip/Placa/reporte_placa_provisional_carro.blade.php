        ...
        <table width="100%" align="center" border="0" class="table tb table-tarea-m table-bordered ">
            <tr>
                <td width="20%" align="right"><strong>
                        <img src="https://radiocresatelital.com/wp-content/uploads/2023/08/ANT-ecuador-logo.png"
                            class=" img-logo-transito-pla main-logo" alt="logo">
                        </img></strong></td>
                ...
                <td width="35%" align="right"><strong><img class=" img-logo-transito-pla main-logo"
                            src="data:image/png;base64,{{ $png_logo_movilidad }}" alt=""></strong></td>

                <td width="5%" align="center"><strong class="titulo2-tam-d">D</strong></td>
            </tr>
            <tr>
                <td width="20%" align="center" colspan=5 class="titulo1-tam-placa">
                    <strong>{{$data['data']['placaActual']}}
                        <img class=" img-logo-transito-pla main-logo"
                            src="data:image/png;base64,{{ $png_logo_movilidad }}" alt="">
                </td>
            </tr>
        </table>
    </div>
