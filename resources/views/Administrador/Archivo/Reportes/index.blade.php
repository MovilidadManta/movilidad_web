...
<div class="main-container">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto col-md-12">
            <div class="d-flex">
                <div class="col-xs-12">
                    <h1 class="content-title mb-0 my-auto color-titulo">Reporte Documentos</h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row row-sm">
                        <div class="card-body">
                            ...
                            <form class="form" novalidate id="form_reporte_documentos" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="table-responsive mt-3">
                                ...
                                <div id="div_table_reporte_documentos" style="display: none;"></div>
                                <div id="div_table_reporte_documentos_charge" class="caratula_chargue">
...
@section('js')
<script type='text/javascript' src='/js/archivo/reporte.js'></script>
@endsection