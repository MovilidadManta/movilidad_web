...
<div class="main-container">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto col-md-12">
            <div class="d-flex">
                <div class="col-md-6">
                    <h1 class="content-title mb-0 my-auto color-titulo">Retiro vehicular</h1>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="card-body">
                            <form class="form" novalidate id="form-certificados-medicos" method="POST" enctype="multipart/form-data">
                                <div class="row" style="margin-bottom: 1em;">
                                    ...
                                    <div class="col-xs-8 col-md-2 mg-b-10">
                                        <select name="select_tipo_ingreso" id="select_tipo_ingreso" class="form-control">
                                        </select>
                                    </div>
                                    <div class="col-xs-12 col-md-2 text-end">
                                        <a class="btn background-btn-nuevo pad-nu btn-buscar-certificado" id="btn_search_vehiculos">
                ...
                <div class="row row-sm">
                    <div class="card-body">
                        <div class="table-responsive">
                            <div id="div_table_retiro_vehiculo_patio">
...
<x-administrador.garita.retiro_vehiculo_patio.modal_cargar_documentos idModalCargarDocumentos="modal_documentos_vehiculo">
</x-administrador.garita.retiro_vehiculo_patio.modal_cargar_documentos>
...
<script type='text/javascript' src='/js/Garita/retiro_vehiculo_documentos.js'></script>
<script type='text/javascript' src='/js/Garita/retiro_vehiculo_patio.js'></script>
@endsection