...
<div class="main-container">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto col-md-12">
            <div class="d-flex">
                <div class="col-md-6">
                    <h2 class="content-title mb-0 my-auto color-titulo">LOTAIP</h2>
...
<!-- INICIO MODAL AÑADIR LOTAIP AÑO -->
<div class="modal" id="modal-lotaip">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Agregar Lotaip</h6><button aria-label="Close" class="close"
                    data-bs-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <input type="hidden" name="csrf-token" value="{{csrf_token()}}" id="csrf-token">
                <form class="form" novalidate id="form-lotaip" method="POST" enctype="multipart/form-data">
                    <div class="row row-sm card-body">
                        <div class="col-lg">
                            <strong>Año</strong>
                            <input class="form-control" name="txt-year" id="txt-year" placeholder="Ingresar Año"
                                type="text">
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-footer">
                <button class="btn btn-success-gradient btn-movi" id="btn-guardar-lotaip" type="button"><i
...
@section('js')
<script type='text/javascript' src='/js/Lotaip/lotaip.js'></script>
@endsection
