...
<div class="main-container">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto col-md-12">
            <div class="d-flex">
                <div class="col-md-6">
                    <h2 class="content-title mb-0 my-auto color-titulo">Organigrama</h2>
    ...
    <!-- breadcrumb -->
    <input type="hidden" value="{{$json_orga}}" id="json_or">
    <!-- row -->
    <div class="row">
        <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
            ...
            <div class="card">
                <div class="card-body">
                    <div id="myDiagramDiv" style="background-color: rgb(52, 52, 60); border: 1px solid black; height: 570px; position: relative; -webkit-tap-highlight-color: rgba(255, 255, 255, 0); cursor: auto;"><canvas tabindex="0" width="1075" height="551" style="position: absolute; top: 0px; left: 0px; z-index: 2; user-select: none; touch-action: none; width: 1075px; height: 551px; cursor: auto;"></canvas>
                        <div style="position: absolute; overflow: auto; width: 1075px; height: 568px; z-index: 1;">
...
@section('js')
<script src="{{asset('lib/gojs/go.js')}}"></script>
<script>
    function init() {
    ...
    function load() {
        myDiagram.model = go.Model.fromJson(document.getElementById("json_or").value);
