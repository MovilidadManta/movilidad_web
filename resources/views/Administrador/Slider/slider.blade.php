    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-footer">
                <button class="btn btn-success-gradient btn-movi" id="btn-guardar-slider" type="button"><i class="fa fa-save"></i> Guardar</button>
...
<div class="modal" id="modal-modificar-slider">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-footer">
                <button class="btn btn-success-gradient btn-movi" id="btn-modificar-slider" type="button"><i class="fa fa-edit"></i> Guardar</button>
                <button class="btn ripple btn-dark-gradient" data-bs-dismiss="modal" type="button"><i class="fas fa-times"></i> Salir</button>
            </div>
        </div>
    </div>
