...
<div class="main-container">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto col-md-12">
            <div class="d-flex">
                <div class="col-md-6">
                    <h2 class="content-title mb-0 my-auto color-titulo">Gestión Slider Intranet</h2>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Agregar Slider</h6><button aria-label="Close" class="close" data-bs-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
            </div>
                        ...
                        <div class="row row-sm">
                            ...
                            <div class="row-sm">
                                <div class="col-lg mg-t-10 mg-lg-t-0">
                                    ...
                                    <textarea class="form-control" id="txt-titulo" name="txt-titulo" rows="2" placeholder="Ingresar Titulo"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row-sm ">
                                <div class="col-lg mg-t-10">
                                    ...
                                    <textarea class="form-control" id="txt-descripcion" name="txt-descripcion" rows="6" placeholder="Ingresar Descripción"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-success-gradient btn-movi" id="btn-guardar-slider_intranet" type="button"><i class="fa fa-save"></i> Guardar</button>
...
<div class="modal" id="modal-modificar-slider">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Modificar Slider</h6><button aria-label="Close" class="close" data-bs-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <input type="hidden" name="csrf-token" value="{{csrf_token()}}" id="csrf-token">
                    ...
                    <div class="card-body">
                        <div class="row row-sm">
                            ...
                            <div class="row-sm">
                                <div class="col-lg mg-t-10 mg-lg-t-0">
                                    <strong>Titulo</strong>
                                    <textarea class="form-control" id="txt-titulo-m" name="txt-titulo-m" rows="2" placeholder="Ingresar Titulo"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row-sm card-body">
                                <div class="col-lg">
                                    <strong>Descripción</strong>
                                    <textarea class="form-control" id="txt-descripcion-m" name="txt-descripcion-m" rows="6" placeholder="Ingresar Descripción"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-success-gradient btn-movi" id="btn-modificar-slider" type="button"><i class="fa fa-edit"></i> Guardar slider</button>
                <button class="btn ripple btn-dark-gradient" data-bs-dismiss="modal" type="button"><i class="fas fa-times"></i> Salir</button>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content tx-size-sm">
            <div class="modal-body tx-center pd-y-20 pd-x-20">
                ...
                <form class="form" novalidate id="form-slider-e" method="POST" enctype="multipart/form-data">
                    ...
                    <button class="btn btn-success-gradient" id="btn-eliminar-slider" type="button"><i class="fa fa-save"></i> Eliminar</button>
                </form>
            </div>
        </div>
    </div>
