...
<div class="main-container">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto col-md-12">
            <div class="d-flex">
                <div class="col-md-6">
                    <h2 class="content-title mb-0 my-auto color-titulo">Gestion de Proyectos</h2>
                </div>
                <div class="col-md-6">
                    <a class="btn background-btn-nuevo pad-nu float-btn-nuevo" id="btn_add_projet">
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <div id="div-table-proyectos"></div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-header">
                <h6 class="modal-title">Agregar Proyecto</h6>
                ...
                <div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block bus-emp-bo">
                    <div class="form-group">
                        ...
                        <div class="pos-relative">
                            <input class="form-control pd-r-80" type="text" id="ip_nombre_proyecto" name="ip_nombre_proyecto">
            ...
            <div class="modal-footer">
                <button class="btn btn-success-gradient btn-movi" id="btn_save_project" type="button"><i class="fa fa-save"></i> Guardar</button>
...
<script type='text/javascript' src='/js/Proyectos/proyectos.js'></script>
@endsection
