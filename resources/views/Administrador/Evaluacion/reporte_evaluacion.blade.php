...
<div class="main-container">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto col-md-12">
            <div class="d-flex">
                <div class="col-md-6">
                    <h2 class="content-title mb-0 my-auto color-titulo">Reporte de evaluación de Desempeño</h2>
                    ...
                    <form class="form" novalidate id="form-m-empleado" method="POST" enctype="multipart/form-data">
                        <!--<div class="row justify-content-center" style="margin-bottom: 1em;">
                            ...
                            <div align='left' class="col-4">
                                <select name="sel_niveles" id="sel_niveles" class="form-control form-select select2">
                                    <option value="0">SELECCIONE UN NIVEL</option>
                                    <option value="1">GERENCIA</option>
                                    <option value="2">DIRECTORES</option>
                                    <option value="3">JEFES</option>
...
@section('js')
<script type='text/javascript' src='/js/Reporte/reporte_evaluacion.js'></script>
@endsection
