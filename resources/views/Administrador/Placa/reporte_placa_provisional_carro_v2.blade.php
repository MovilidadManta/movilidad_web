...
<head>
    ...
    <style>
      @page {
        ...
        .section_placas{
          width: 404mm;                /* riel exacto */
          margin: 0 auto;
          padding: 0 19.8mm;         /* bordes iguales */
          padding-top: 10mm;
          box-sizing: border-box;
          overflow: hidden;
        }
      ...
      .div_letter_dash{
        float:left;
        width:40mm;              /* ajusta a gusto */
        height:74mm;
        line-height:74mm;
        text-align:center;
        font-size:21.1mm;          /* tamaño del “-” */
        border:none;
      }
      .section_datos{
        width: 404mm;                /* riel exacto */
      ...
      <div class="section_placas">
        @foreach (str_split($placa_moto) as $letra_placa)
          <div class="div_letter">
            <img
              src="{{ public_path("Imagenes/dist/letras/carro/{$letra_placa}.png") }}"
              alt="{{$letra_placa}}">
            </img>
          </div>
          <div class="div_letter_space">
           ...
           @if ($loop->iteration == 3)
                <div class="div_letter_dash">
                  <img
                  src="{{ public_path("Imagenes/dist/letras/carro/minus_math.png") }}"
                  alt="minus_math.png">
                </img>
                </div>
                <div class="div_letter_space"></div>
            @endif
