...
<div class="main-container">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto col-md-12">
            <div class="d-flex">
                <div class="col-md-6">
                    <h2 class="content-title mb-0 my-auto color-titulo" id="title_formulario">Reporte General de Test
                    </h2>
                </div>
            </div>
        </div>
                    ...
                    <form class="form" novalidate id="form-certificados-medicos" method="POST"
                        ...
                        <div class="row" style="margin-bottom: 1em;">
                            ...
                            <div class="col-xs-12 col-md-2 text-end">
                                <a class="btn background-btn-nuevo pad-nu btn-buscar-certificado" id="btn-reporte-test">
...
@section('js')
<script type='text/javascript' src='/js/Test/reporte_test.js'></script>
@endsection
