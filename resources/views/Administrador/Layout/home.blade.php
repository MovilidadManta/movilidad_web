...
<div class="breadcrumb-header justify-content-between">
    <div class="left-content">
        <div>
            <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">Hola, bienvenido al Sistema de Gestión Interno de la
                Empresa Pública Municipal Movilidad de Manta-EP.</h2>
        </div>
    </div>
    <div class="main-dashboard-header-right none">
        <div>
...
<div class="row row-sm">
    <div class="col-lg-6 col-xl-3 col-md-6 col-12">
        <div class="card bg-primary-gradient text-white heigth-card">
            <div class="card-body ">
                <div class="row">
                    <div class="col-5">
                    ...
                    <div class="col-7">
                        <div class="mt-0 text-center">
                            <span class="text-white">Total de Empleados</span>
                            <h2 class="text-white mb-0">
                                @foreach($t_empleados as $e)
                                {{$e->count}}
                                @endforeach
                            </h2>
                        </div>
    ...
    <div class="col-lg-6 col-xl-3 col-md-6 col-12">
        <div class="card bg-success-gradient text-white heigth-card">
            <div class="card-body">
                <div class="row">
                    <div class="col-5">
                        <div class="icon1 mt-2 text-center">
                    ...
                    <div class="col-7">
                        <div class="mt-0 text-center">
                            <span class="text-white">Total de Usuarios</span>
                            <h2 class="text-white mb-0">
                                @foreach($t_usuarios as $e)
                                {{$e->count}}
                                @endforeach
                            </h2>
                        </div>
    ...
    <div class="col-lg-6 col-xl-3 col-md-6 col-12">
        <div class="card bg-warning-gradient text-white heigth-card">
            <div class="card-body">
                <div class="row">
                    <div class="col-5">
                        <div class="icon1 mt-2 text-center">
                            <i class="fa fa-window-restore tx-40"></i>
                        </div>
                    </div>
                    <div class="col-7">
                        <div class="mt-0 text-center">
                            <span class="text-white">Total de Noticias</span>
    ...
    <div class="col-lg-6 col-xl-3 col-md-6 col-12">
        <div class="card bg-danger-gradient text-white heigth-card">
            <div class="card-body">
                <div class="row">
                    <div class="col-5">
                        <div class="icon1 mt-2 text-center">
                            <i class="fa fa-bus tx-40"></i>
                        </div>
                    </div>
                    <div class="col-7">
                        <div class="mt-0 text-center">
                            <span class="text-white">Total de Cooperativas</span>
                            <h2 class="text-white mb-0">0</h2>
                        </div>
                    </div>
                </div>
        ...
        <div class="card bg-warning-gradient text-white heigth-card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="mt-0 text-center">
                            <span class="text-white">Total de Lugares Turisticos</span>
                            <h2 class="text-white mb-0">0</h2>
                        </div>
                    </div>
                </div>
        ...
        <div class="card bg-danger-gradient text-white heigth-card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="mt-0 text-center">
                            <span class="text-white">Total de Centros Comerciales</span>
                            <h2 class="text-white mb-0">0</h2>
                        </div>
                    </div>
                </div>
        ...
        <div class="card bg-primary-gradient text-white heigth-card">
            <div class="card-body">
                <div class="row">
                    <div class="col-5">
                        <div class="icon1 mt-2 text-center">
                            <i class="fa fa-globe tx-40"></i>
                        </div>
                    </div>
                    <div class="col-7">
                        <div class="mt-0 text-center">
                            <span class="text-white">Total de Servicios</span>
                            <h2 class="text-white mb-0">0</h2>
                        </div>
                    </div>
                </div>
        ...
        <div class="card bg-success-gradient text-white heigth-card">
            <div class="card-body">
                <div class="row">
                    <div class="col-5">
                        <div class="icon1 mt-2 text-center">
                            <i class="fa fa-th-list tx-40"></i>
                        </div>
                    </div>
                    <div class="col-7">
                        <div class="mt-0 text-center">
                            <span class="text-white">Total de Slider</span>
                            <h2 class="text-white mb-0">0</h2>
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body p-0 customers mt-1">
                <div class="list-group list-lg-group list-group-flush">
                    ...
                    <div class="list-group-item list-group-item-action br-t-1" href="javascript:void(0);">
                        <div class="media mt-0">
                    ...
                    <div class="list-group-item list-group-item-action br-t-1 br-br-7 br-bl-7" href="javascript:void(0);">
                        <div class="media mt-0">
        ...
        <div class="card">
            ...
            <div class="product-timeline card-body pt-2 mt-1">
                <ul class="timeline-1 mb-0">
                    <li class="mt-0" id="mrg-8"> <i class="ti-pie-chart bg-primary-gradient text-white product-icon"></i> <span class="fw-semibold mb-4 tx-14 ">Total Products</span> <a href="javascript:void(0);" class="float-end tx-11 text-muted">3 days ago</a>
                        <p class="mb-0 text-muted tx-12">1.3k New Products</p>
                    </li>
                    <li class="mt-0" id="mrg-8"> <i class="mdi mdi-cart-outline bg-danger-gradient text-white product-icon"></i> <span class="fw-semibold mb-4 tx-14 ">Total Sales</span> <a href="javascript:void(0);" class="float-end tx-11 text-muted">35 mins ago</a>
                        <p class="mb-0 text-muted tx-12">1k New Sales</p>
                    </li>
                    <li class="mt-0" id="mrg-8"> <i class="ti-bar-chart-alt bg-success-gradient text-white product-icon"></i> <span class="fw-semibold mb-4 tx-14 ">Toatal Revenue</span> <a href="javascript:void(0);" class="float-end tx-11 text-muted">50 mins ago</a>
                        <p class="mb-0 text-muted tx-12">23.5K New Revenue</p>
                    </li>
                    <li class="mt-0" id="mrg-8"> <i class="ti-wallet bg-warning-gradient text-white product-icon"></i> <span class="fw-semibold mb-4 tx-14 ">Toatal Profit</span> <a href="javascript:void(0);" class="float-end tx-11 text-muted">1 hour ago</a>
                        <p class="mb-0 text-muted tx-12">3k New profit</p>
                    </li>
                    <li class="mt-0" id="mrg-8"> <i class="si si-eye bg-purple-gradient text-white product-icon"></i> <span class="fw-semibold mb-4 tx-14 ">Customer Visits</span> <a href="javascript:void(0);" class="float-end tx-11 text-muted">1 day ago</a>
