...
<body class="main-body app sidebar-mini ltr">
    ...
    <div class="page custom-index">
                                        ...
                                        <div class="dropdown  nav-item">
                                            <a href="javascript:void(0);"
                                                ...
                                                <span class="avatar country-Flag me-0 align-self-center bg-transparent">
                                                    <img src="https://m.media-amazon.com/images/I/51sMyQo0kAL._AC_SX679_.jpg"
                                                        alt="img">
                                                </span>
                                                <div class="my-auto">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-start  dropdown-menu-arrow"
                                                ...
                                                <a href="javascript:void(0);" class="dropdown-item d-flex">
                                                    <span class="avatar  me-3 align-self-center bg-transparent">
                                                        <img src="/valex/assets/img/flags/germany_flag.jpg" alt="img">
                                                    </span>
                                                    <div class="d-flex">
                                                ...
                                                <a href="javascript:void(0);" class="dropdown-item d-flex">
                                                    <span class="avatar me-3 align-self-center bg-transparent">
                                                        <img src="/valex/assets/img/flags/italy_flag.jpg" alt="img">
                                                    </span>
                                                    <div class="d-flex">
                                                ...
                                                <a href="javascript:void(0);" class="dropdown-item d-flex">
                                                    <span class="avatar me-3 align-self-center bg-transparent">
                                                        <img src="/valex/assets/img/flags/russia_flag.jpg" alt="img">
                                                    </span>
                                                    <div class="d-flex">
                                                ...
                                                <a href="javascript:void(0);" class="dropdown-item d-flex">
                                                    <span class="avatar  me-3 align-self-center bg-transparent">
                                                        <img src="/valex/assets/img/flags/spain_flag.jpg" alt="img">
                                                    </span>
                                                    <div class="d-flex">
                                        ...
                                        <div class="dropdown-menu">
                                            <div class="menu-header-content bg-primary text-start">
                                                <div class="d-flex">
                                                    ...
                                                    <span
                                                        class="badge rounded-pill bg-warning ms-auto my-auto float-end">
                                                        Mark
                                                        All Read
                                                    </span>
                                                </div>
                                            ...
                                            <div class="main-message-list chat-scroll">
                                                <a href="javascript:void(0);" class="p-3 d-flex border-bottom">
                                                    <div class="  drop-img  cover-image  "
                                                        data-bs-image-src="/valex/assets/img/faces/3.jpg">
                                                ...
                                                <a href="javascript:void(0);" class="p-3 d-flex border-bottom">
                                                    <div class="drop-img cover-image"
                                                        data-bs-image-src="/valex/assets/img/faces/2.jpg">
                                                        <span class="avatar-status bg-teal"></span>
                                                    </div>
                                                    <div class="wd-90p">
                                                        <div class="d-flex">
                                                ...
                                                <a href="javascript:void(0);" class="p-3 d-flex border-bottom">
                                                    <div class="drop-img cover-image"
                                                        data-bs-image-src="/valex/assets/img/faces/9.jpg">
                                                        <span class="avatar-status bg-teal"></span>
                                                    </div>
                                                    <div class="wd-90p">
                                                        <div class="d-flex">
                                                ...
                                                <a href="javascript:void(0);" class="p-3 d-flex border-bottom">
                                                    <div class="drop-img cover-image"
                                                        data-bs-image-src="/valex/assets/img/faces/12.jpg">
                                                        <span class="avatar-status bg-teal"></span>
                                                    </div>
                                                    <div class="wd-90p">
                                                        <div class="d-flex">
                                                ...
                                                <a href="javascript:void(0);" class="p-3 d-flex border-bottom">
                                                    <div class="drop-img cover-image"
                                                        data-bs-image-src="/valex/assets/img/ faces/5.jpg">
                                                        <span class="avatar-status bg-teal"></span>
                                                    </div>
                                                    <div class="wd-90p">
                                                        <div class="d-flex">
                                            ...
                                            <div class="main-header-profile bg-primary p-3">
                                                <div class="d-flex wd-100p">
                                                    <div class="main-img-user">
                                                        <img alt=""
                                                            src="/imagenes_empleados/{{ Session::get('ruta_foto') }}"
                                                            class="">
                                                    </div>
                ...
                <aside class="app-sidebar sidebar-scroll">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <!-- ADMINISTRADOR -->
                            <li class="side-item side-item-category">Pagina WEB</li>
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                    ...
                                    <span class="side-menu__label">Empleado</span>
                                    <i class="angle fe fe-chevron-down"></i>
                                </a>
                                <ul class="slide-menu">
                                    <li>
                                        <a class="slide-item" href="/nomina">Nómina</a>
                                    </li>
                                    <li>
                                        <a class="slide-item" href="/credencial">Credencial</a>
                                    </li>
                                    <li>
                                        <a class="slide-item" href="/acuerdo">Acuerdos</a>
                                    </li>
                                    <li>
                                        <a class="slide-item" href="/hoja-ruta">Paz y Salvo</a>
                                    </li>
                                    <li>
                                        <a class="slide-item" href="/evaluacion">Evaluación</a>
                                    </li>
                                    <li>
                                        <a class="slide-item" href="/correo">Correo</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                    ...
                                    <span class="side-menu__label">Mision y Vision</span>
                                    <i class="angle fe fe-chevron-down"></i>
                                </a>
                                <ul class="slide-menu">
                                    <li>
                                        <a class="slide-item" href="/admin-nosotro">Gestion Mision Vision</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                    ...
                                    <span class="side-menu__label">Consolidado</span>
                                    <i class="angle fe fe-chevron-down"></i>
                                </a>
                                <ul class="slide-menu">
                                    <li>
                                        <a class="slide-item" href="/consolidado">Gestion Consolidado</a>
                                    </li>
                                    <li>
                                        <a class="slide-item" href="/consolidado-reporte">Reporte Consolidado</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                    ...
                                    <span class="side-menu__label">Rendicion de Cuenta</span>
                                    <i class="angle fe fe-chevron-down"></i>
                                </a>
                                <ul class="slide-menu">
                                    <li>
                                        <a class="slide-item" href="/admin-rendicion-cuenta">
                                            Gestion Rendición de
                                            Cuenta
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                    ...
                                    <span class="side-menu__label">LOTAIP</span>
                                    <i class="angle fe fe-chevron-down"></i>
                                </a>
                                <ul class="slide-menu">
                                    <!--<li><a class="slide-item" href="/admin-registrar-lotaip">Registrar Lotaip</a></li>-->
                                    <li>
                                        <a class="slide-item" href="/admin-lotaip">Gestion Lotaip</a>
                                    </li>
                                    <li>
                                        <a class="slide-item" href="/admin-literal-lotaip">
                                            Gestion Literal
                                            Lotaip
                                        </a>
                                    </li>
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                    ...
                                    <span class="side-menu__label">Noticias</span>
                                    <i class="angle fe fe-chevron-down"></i>
                                </a>
                                <ul class="slide-menu">
                                    <!--<li><a class="slide-item" href="/admin-registrar-lotaip">Registrar Lotaip</a></li>-->
                                    <li>
                                        <a class="slide-item" href="/admin-noticia">Noticia</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                    ...
                                    <span class="side-menu__label">Contáctanos</span>
                                    <i class="angle fe fe-chevron-down"></i>
                                </a>
                                <ul class="slide-menu">
                                    <li>
                                        <a class="slide-item" href="/admin-contactano">Gestión Contáctanos</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li>
                                        <a class="slide-item" href="/admin-slider-index">Gestión Slider</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                    ...
                                    <span class="side-menu__label">Cooperativa</span>
                                    <i class="angle fe fe-chevron-down"></i>
                                </a>
                                <ul class="slide-menu">
                                    <li>
                                        <a class="slide-item" href="/admin-cooperativa">Gestion Cooperativa</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                    ...
                                    <span class="side-menu__label">Destino</span>
                                    <i class="angle fe fe-chevron-down"></i>
                                </a>
                                <ul class="slide-menu">
                                    <li>
                                        <a class="slide-item" href="/admin-destino">Gestion Destino</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                    ...
                                    <span class="side-menu__label">Turismo</span>
                                    <i class="angle fe fe-chevron-down"></i>
                                </a>
                                <ul class="slide-menu">
                                    <li>
                                        <a class="slide-item" href="/admin-turismo">Gestion Turismo</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li>
                                        <a class="slide-item" href="/admin-turismo">Gestion Eventos</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                    ...
                                    <span class="side-menu__label">Procesos</span>
                                    <i class="angle fe fe-chevron-down"></i>
                                </a>
                                <ul class="slide-menu">
                                    <li>
                                        <a class="slide-item" href="/admin-proceso">Gestión Procesos</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                    ...
                                    <span class="side-menu__label">Inventarios</span>
                                    <i class="angle fe fe-chevron-down"></i>
                                </a>
                                <ul class="slide-menu">
                                    <li>
                                        <a class="slide-item" href="/admin-catalogo">Gestión Catalogo</a>
                                    </li>
                                    <li>
                                        <a class="slide-item" href="/admin-inventario">Gestión Inventario</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li>
                                        <a class="slide-item" href="/admin-reporte-nomina">Reporte de Nómina</a>
                                    </li>
                                    <li>
                                        <a class="slide-item" href="/admin-ip">IP's</a>
                                    </li>
                                    <li>
                                        <a class="slide-item" href="/admin-reporte-equipo">Reporte de Equipos</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li>
                                        <a class="slide-item" href="/usuario">Gestión Usuarios</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li>
                                        <a class="slide-item" href="/proyectos">Gestión Proyectos</a>
                                    </li>
                                    <li>
                                        <a class="slide-item" href="/menu">Gestión Menus</a>
                                    </li>
                                    <li>
                                        <a class="slide-item" href="/submenu">Gestión Submenus</a>
                                    </li>
                                </ul>
                            </li>
                            @endif

                            @if (Session::get('id_jefatura') == 13)
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                                        <path d="M0 0h24v24H0V0z" fill="none" />
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li>
                                        <a class="slide-item" href="/reporte-nomina">Reporte de Nómina</a>
                                    </li>
                                </ul>
                            </li>
                            @endif
        ...
        <!-- /main-content -->
        <!-- Footer opened -->
        <div class="main-footer ht-45 footer">
