...
<div class="main-container">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto col-md-12">
            <div class="d-flex">
                <div class="col-md-6">
                    <h2 class="content-title mb-0 my-auto color-titulo">Modificar Empleado</h2>
    ...
    <div class="row">
        <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
            <!--div-->
            <form class="form" id="form-empleado-modificar" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="csrf-token" value="{{csrf_token()}}" id="csrf-token">
                <input type="hidden" name="txt-prioridad-modificar" id="txt-prioridad-modificar">
                <input type="hidden" name="txt-id-empleado" id="txt-id-empleado" value="{{$id}}">
                        ...
                        <div class="row row-sm">
                            ...
                            <div class="row row-sm mg-t-20">
                                ...
                                <div class="col-lg mg-t-10 mg-lg-t-0">
                                    ...
                                    <!--<div class="tam-img">
                                        <div class="image-upload-wrap image-upload-wrap-img">
                                            <input class="file-upload-input" type='file' name="txt-ruta-foto" id="txt-ruta-foto" onchange="readURL(this);" accept="image/*" />
                                            <div class="drag-text drag-text-img">
                                                <h3>Foto</h3>
                                            </div>
                                        </div>
                                        <div class="file-upload-content file-upload-content-img">
                                            <img class="file-upload-image tam-img-emp" src="#" alt="your image" />
                                            <div class="image-title-wrap">
                                                <button type="button" onclick="removeUpload()" class="remove-image remove-image-img">
                                                    <span class="image-title">Uploaded Image</span></button>
                                                    <i class="fa fa-trash tam-icono"></i>
                                            </div>
                                        </div>-->
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row row-sm">
                                ...
                                <div class="row row-sm card-body">
                                    ...
                                    <div class="col-lg mg-t-10 mg-lg-t-0">
                                        <strong>Cargo</strong>
                                        <input type="hidden" class="form-control" name="text-cargo-m" id="text-cargo-m"
                    ...
                    <div class="card box-sha">
                        <div class="card-body">
                            ...
                            <input class="form-control" name="txt-porcentaje" id="txt-porcentaje" placeholder="Ingresar Porcentaje" type="text">-->
                                ...
                                <div class="row row-sm card-body">
                                    <div class="col-lg" id="div-table-prioridad"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 cen ubica" align="center">
                        <button class="btn btn-primary btn btn-success-gradient btn-movi" id="btn-modificar-empleado"
                            type="button">
...
@section('js')
<script type="text/javascript" src="/js/Empleado/modificar_empleado.js?v=20250918"></script>
<script>
