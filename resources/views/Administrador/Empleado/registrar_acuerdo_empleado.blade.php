...
<div class="main-container">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto col-md-12">
            <div class="d-flex">
                <div class="col-md-6">
                    <h2 class="content-title mb-0 my-auto color-titulo">Gestion de Acuerdos</h2>
                            ...
                            <div class="card-body pd-20">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="pos-relative">
                                        <input class="form-control pd-r-80" required="" type="text" id="txt-buscar" name="txt-buscar">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-header">
                <h6 class="modal-title">Subir Acuerdo</h6><button aria-label="Close" class="close" data-bs-dismiss="modal" type="button"><span aria-hidden="true">×</span></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <input type="hidden" name="csrf-token" value="{{csrf_token()}}" id="csrf-token">
                        <form class="form" novalidate id="form-acuerdo-responsabilidad-confidencialidad" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="txt-id-empleado" id="txt-id-empleado">
                            <input type="hidden" name="txt-tipo-acuerdo" id="txt-tipo-acuerdo">
                            <input type="file" class="dropify" id="txt-archivo-acuerdo-responsabilidad" name="txt-archivo-acuerdo-responsabilidad" data-max-file-size="3M" />
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content tx-size-sm">
            <div class="modal-body tx-center pd-y-20 pd-x-20">
                ...
                <form class="form" novalidate id="form-acuerdo-e" method="POST" enctype="multipart/form-data">
                    ...
                    <button class="btn btn-success-gradient" id="btn-eliminar-acuerdo" type="button"><i class="fa fa-times-circle"></i> Eliminar</button>
                </form>
            </div>
        </div>
    </div>
...
@section('js')
<script type='text/javascript' src='/js/Empleado/acuerdo_reponsabilidad_empleado.js'></script>
@endsection
