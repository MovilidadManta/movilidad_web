...
<div class="main-container">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto col-md-12">
            <div class="d-flex">
                <div class="col-md-6">
                    <h2 class="content-title mb-0 my-auto color-titulo" id="title_formulario">Reporte de Certificados Médicos</h2>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <form class="form" novalidate id="form-certificados-medicos" method="POST" enctype="multipart/form-data">
                        <div class="row" style="margin-bottom: 1em;">
                            ...
                            <div class="col-xs-12 col-md-2 text-end">
                                <a class="btn background-btn-nuevo pad-nu btn-buscar-certificado" id="btn-reporte-certificados">
                    ...
                    <div class="row row-sm">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <div id="div-table-reporte-certificados"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('js')
<script type='text/javascript' src='/js/Medico/reporte_solicitud_permiso_medico.js'></script>
@endsection
