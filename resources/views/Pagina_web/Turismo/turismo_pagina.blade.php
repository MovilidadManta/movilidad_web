    ...
    <div class="av-container width-t">
        <div class="av-columns-area wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
            <div id="av-primary-content" class="av-column-12 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                <p class="has-text-align-justify has-text-color margin-b-no" style="color:#009fe3;font-size:15px">Manta
                    es una ciudad que enamora en cada rincón, con playas paradisiacas, un hermoso bosque encantado a
                    pocos minutos del centro urbano y obras emblemáticas como el Espigón y el Megaparque Agustín
                    Intriago. Conozca más de los encantos de nuestra ciudad.</p>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-9">
                                <div class="container">
                                    <div class="row">
                                        <div id="div-table-turismo" align='center'>
...
@section('js')
<script type="text/javascript" src="/js/Turismo/turismo_pagina.js"></script>
@endsection