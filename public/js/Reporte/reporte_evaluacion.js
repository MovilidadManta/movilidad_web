...
function get_empleado_reporte() {
    ...
    if (niveles == 0) {
        ...
        $.ajax({
            url: "/get-reporte-evaluacion/" + id_direccion + "/" + id_jefatura + "/" + regimen_contractual,
            type: "GET",
            dataType: "json",
            success: function (response) {
                ...
                if (response.data != null) {
                    ...
                    /*ht +=
                        "                     <h3>La Nomina tiene " + response.total_empleado + " empleados registrados</h3>";
                    //ht += '                     <a href=""><i class="far fa-file-excel tam-excell"></i></a>'
                    ht += "                 </div>";*/
                    ht += '                 <div class="col-md-12 marg">';
                    //ht += '                     <a target="_blank" href="/imprimir-pdf-evaluacion/' + id_direccion + "/" + id_jefatura + "/" + regimen_contractual + '"><i class="far fa-file-pdf tam-pdf"></i></a>';
                    //ht += '                     <a target="_blank" href="/imprimir-excel-evaluacion/' + id_direccion + "/" + id_jefatura + "/" + regimen_contractual + '"><i class="far fa-file-excel tam-excell"></i></a>';
                    //ht += '                     <a href=""><i class="far fa-file-excel tam-excell"></i></a>'
                    ht += "                 </div>";
                }
                ht +=
                ...
                //ht += '				                <th align="center" class="border-bottom-0 color-th">Salario</th>';
                ...
                $(response.data).each(function (i, data) {
                    ...
                    /*ht += '				        <td class="color-td" align="center"><img class="tam-ima-emp-ta" src="http://sgi.movilidadmanta.gob.ec/imagenes_empleados/' +
                        data.emp_ruta_foto +
                        '" alt=""></td>';*/
                    ...
                    if (data.ev_total == null) {
                        ht += '				        <td class="color-td" align="center"> 0.00 %</td>';
                    } else {
                        ht += '				        <td class="color-td" align="center">' + data.ev_total + " %</td>";
                    }
